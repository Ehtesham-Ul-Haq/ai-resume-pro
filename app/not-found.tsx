...
export default function NotFound() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-950 text-gray-50 p-6 font-mono relative overflow-hidden">
      ...
      <div className="relative z-10 text-center bg-gray-900 bg-opacity-80 backdrop-blur-md p-8 md:p-16 rounded-3xl border border-blue-700 dark:border-purple-700 shadow-[0_0_50px_rgba(59,130,246,0.3)] dark:shadow-[0_0_50px_rgba(168,85,247,0.3)]
        ...
        <h1 className="text-8xl md:text-9xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500 drop-shadow-lg
